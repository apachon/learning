...
- [x] [Mission: Create Chatbots with SAP Conversational AI](https://developers.sap.com/mission.cai-get-started.html)
- [x] [Mission: Get Started with Document Information Extraction](https://developers.sap.com/mission.cp-aibus-extract-document-service.html)
- [ ] [Mission: Use Machine Learning to Classify Data Records](https://developers.sap.com/mission.cp-aibus-data-attribute.html)
- [ ] [Mission: Use Machine Learning to Enrich Data Extracted from Documents](https://developers.sap.com/mission.cp-aibus-extract-document-enrich-data.html)
- [ ] [Mission: Use Machine Learning to Process Service Requests](https://developers.sap.com/mission.cp-aibus-sti-service-requests.html)
- [ ] [Mission: Classify Data Records with the SDK for Data Attribute Recommendation](https://developers.sap.com/group.cp-aibus-data-attribute-sdk.html)
- [ ] [Mission: Connect Your SAP Conversational AI Chatbot to External Services](https://developers.sap.com/group.conversational-ai-external-services.html)
- [x] [Mission: Create Chatbot for Customers of Shipping Company](https://developers.sap.com/group.cai-shipping-bot.html)
- [ ] [Mission: Use Machine Learning to Classify Documents (Enterprise Account)](https://developers.sap.com/group.cp-aibus-classify-documents-enterprise.html)
- [ ] [Mission: Use Machine Learning to Classify Documents (Trial Account)](https://developers.sap.com/group.cp-aibus-classify-documents-trial.html)
- [ ] [Mission: Use Machine Learning to Process Unstructured Text](https://developers.sap.com/group.cp-aibus-business-entity-detect.html)
- [x] [Mission: Add Webhook to Chatbot to Retrieve Tracking Info](https://developers.sap.com/tutorials/cai-bot-shipping-2-api.html)
- [ ] [Mission: Build a Webhook for a Chatbot using Python](https://developers.sap.com/tutorials/conversational-ai-webhook-script-python.html)
- [x] [Mission: Build Your First Chatbot with SAP Conversational AI](https://developers.sap.com/tutorials/cai-bot-getting-started.html)
- [ ] [Mission: Build Your First FAQ Chatbot](https://developers.sap.com/tutorials/conversational-ai-faq-chatbot-beginner.html)
- [ ] [Mission: Classify Documents with Document Classification](https://developers.sap.com/tutorials/cp-aibus-dc-classify.html)
- [ ] [Mission: Consume API Services and Call Webhooks from Your Chatbot](https://developers.sap.com/tutorials/conversational-ai-webhook-api-call.html)
- [x] [Mission: Create a Chatbot that Lets Customers Track Packages](https://developers.sap.com/tutorials/cai-bot-shipping-1-track-bot.html)
- [ ] [Mission: Create Service Instance for Business Entity Recognition](https://developers.sap.com/tutorials/cp-aibus-ber-service-instance.html)
- [ ] [Mission: Create Service Instance for Data Attribute Recommendation](https://developers.sap.com/tutorials/cp-aibus-dar-service-instance.html)
- [ ] [Mission: Create Service Instance for Document Classification with Customer Account](https://developers.sap.com/tutorials/cp-aibus-dc-prod-service-instance.html)
- [ ] [Mission: Create Service Instance for Document Classification with Trial Account](https://developers.sap.com/tutorials/cp-aibus-dc-service-instance.html)
- [x] [Mission: Create Service Instance for Document Information Extraction](https://developers.sap.com/tutorials/cp-aibus-dox-service-instance.html)
- [ ] [Mission: Create Service Instance for Service Ticket Intelligence](https://developers.sap.com/tutorials/cp-aibus-sti-service-instance.html)
- [ ] [Mission: Create Service Keys for Document Information Extraction](https://developers.sap.com/tutorials/cp-aibus-dox-service-instance-booster.html)
- [ ] [Mission: Deploy an SAP Conversational AI Chatbot on a Web Site](https://developers.sap.com/tutorials/conversational-ai-deploy-web.html)
- [ ] [Mission: Deploy an SAP Conversational AI ChatBot on Facebook Messenger](https://developers.sap.com/tutorials/cai-facebook-messenger-bot-create.html)
- [ ] [Mission: Detect and Highlight Entities from Unstructured Text](https://developers.sap.com/tutorials/cp-aibus-ber-swagger-ui.html)
- [ ] [Mission: Get OAuth Access Token for Business Entity Recognition via Web Browser](https://developers.sap.com/tutorials/cp-aibus-ber-web-oauth-token.html)
- [ ] [Mission: Get OAuth Access Token for Document Classification via Web Browser](https://developers.sap.com/tutorials/cp-aibus-dc-web-oauth-token.html)
- [x] [Mission: Get OAuth Access Token for Document Information Extraction via Web Browser](https://developers.sap.com/tutorials/cp-aibus-dox-web-oauth-token.html)
- [x] [Mission: Let Customers Ask Chatbot for Shipping Price](https://developers.sap.com/tutorials/cai-bot-shipping-3-price-parcel.html)
- [ ] [Mission: Set Up Jupyter Notebook and Client Library for Document Classification](https://developers.sap.com/tutorials/cp-aibus-dc-setup.html)
- [ ] [Mission: Set Up Jupyter Notebook for Service Ticket Intelligence](https://developers.sap.com/tutorials/cp-aibus-sti-jupyter-setup.html)
- [ ] [Mission: Set Up Postman to Call Data Attribute Recommendation APIs](https://developers.sap.com/tutorials/cp-aibus-dar-setup-postman.html)
- [ ] [Mission: Set Up Postman to Call Service Ticket Intelligence APIs](https://developers.sap.com/tutorials/cp-aibus-sti-setup-postman.html)
- [ ] [Mission: Set Up the SDK for Data Attribute Recommendation](https://developers.sap.com/tutorials/cp-aibus-dar-sdk-setup.html)
- [ ] [Mission: Train and Deploy a Machine Learning Model in Document Classification](https://developers.sap.com/tutorials/cp-aibus-dc-model.html)
- [ ] [Mission: Upload Data to Data Attribute Recommendation](https://developers.sap.com/tutorials/cp-aibus-dar-upload-data.html)
- [ ] [Mission: Upload Data to Document Classification](https://developers.sap.com/tutorials/cp-aibus-dc-upload.html)
- [ ] [Mission: Use Data Attribute Recommendation to Classify Records, Delete Model and Dataset](https://developers.sap.com/tutorials/cp-aibus-dar-classify-delete.html)
- [ ] [Mission: Use Data Attribute Recommendation to Train a Machine Learning Model](https://developers.sap.com/tutorials/cp-aibus-dar-model.html)
- [ ] [Mission: Use Data Attribute Recommendation With Your Own Dataset](https://developers.sap.com/tutorials/cp-aibus-dar-custom-dataset.html)
- [ ] [Mission: Use Machine Learning to Classify Documents](https://developers.sap.com/tutorials/cp-aibus-dc-swagger-ui.html)
- [ ] [Mission: Use Machine Learning to Enrich Business Data](https://developers.sap.com/tutorials/cp-aibus-dox-data-api-bus.html)
- [ ] [Mission: Use Machine Learning to Enrich Employee Data](https://developers.sap.com/tutorials/cp-aibus-dox-data-api-emp.html)
- [x] [Mission: Use Machine Learning to Extract Information from Documents](https://developers.sap.com/tutorials/cp-aibus-dox-swagger-ui.html)
- [ ] [Mission: Use Service Ticket Intelligence and Jupyter Notebook to Classify Service Requests](https://developers.sap.com/tutorials/cp-aibus-sti-jupyter-classification.html)
- [ ] [Mission: Use Service Ticket Intelligence and Jupyter Notebook to Get Solution Recommendations](https://developers.sap.com/tutorials/cp-aibus-sti-jupyter-recommendation.html)
- [ ] [Mission: Use Service Ticket Intelligence and Postman to Classify Service Requests](https://developers.sap.com/tutorials/cp-aibus-sti-postman-classification.html)
- [ ] [Mission: Use Service Ticket Intelligence and Postman to Get Solution Recommendations](https://developers.sap.com/tutorials/cp-aibus-sti-postman-rec.html)
- [ ] [Mission: Use the SDK for Data Attribute Recommendation](https://developers.sap.com/tutorials/cp-aibus-dar-sdk-usage.html)
...
- [x] [fast.ai: Deep Learning for Coder (2019)](https://course.fast.ai/)
    ...
    - [x] [Lesson 4](https://course19.fast.ai/videos/?lesson=4)
...
- [ ] [Paper: The Platform is the Message](https://papers.ssrn.com/sol3/papers.cfm?abstract_id=3132758)
- [ ] [Paper: A Mulching Proposal](https://arxiv.org/abs/1908.06166)
...
- [x] [Coursera: Machine Learning Course by Stanford University (Andrew Ng)](https://www.coursera.org/learn/machine-learning?ranMID=40328&ranEAID=je6NUbpObpQ&ranSiteID=je6NUbpObpQ-vN7fby8wEMs2z8HgNb6n4Q&siteID=je6NUbpObpQ-vN7fby8wEMs2z8HgNb6n4Q&utm_content=10&utm_medium=partners&utm_source=linkshare&utm_campaign=je6NUbpObpQ)
	- [x] Introduction
...
### Stoicism
- [x] [Book: How To Be A Stoic: Ancient Wisdom for Modern Living](https://www.amazon.es/How-Be-Stoic-Massimo-Pigliucci/dp/184604507X/ref=sr_1_3?adgrpid=58951514089&dchild=1&gclid=EAIaIQobChMIxLSq_qHf6wIVhLh3Ch2DZAqKEAAYASAAEgKub_D_BwE&hvadid=275451558474&hvdev=c&hvlocphy=1005423&hvnetw=g&hvqmt=e&hvrand=2679232129465054270&hvtargid=kwd-298485835668&hydadcr=7920_1827913&keywords=massimo+pigliucci&qid=1599764186&sr=8-3&tag=hydes-21)
